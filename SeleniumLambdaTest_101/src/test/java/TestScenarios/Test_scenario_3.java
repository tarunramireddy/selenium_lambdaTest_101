...
class T1 implements Runnable {    // With chrome 88.0 in windows 10
public void run() {
    ...
    Test_scenario_3 r1 = new Test_scenario_3();
    r1.executeTest(capsHashtable);
}
}
class T2 implements Runnable {      // with MicrosoftEdge 87.0 in macOS sierra
  public void run() {
      Hashtable<String, String> capsHashtable = new Hashtable<String, String>();
      ...
      Test_scenario_3 r2 = new Test_scenario_3();
      r2.executeTest(capsHashtable);
  }
}
class T3 implements Runnable {     // with Firefox 82.0 in windows 7
  public void run() {
      Hashtable<String, String> capsHashtable = new Hashtable<String, String>();
      ...
      Test_scenario_3 r3 = new Test_scenario_3();
...
public class Test_scenario_3 {
  ...
  public static void main(String[] args) throws Exception {
    Thread object1 = new Thread(new T1());
    object1.start();
    Thread object2 = new Thread(new T2());
    object2.start();
    Thread object3 = new Thread(new T3());
    object3.start();
  }
